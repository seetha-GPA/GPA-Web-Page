        ...
        <div className="min-h-screen font-sans flex flex-col">
            ...
            <div className="py-20 px-6 md:px-12 lg:px-24 bg-white">
                <div className="max-w-5xl">
                    ...
                    <div className="space-y-6">
                        {[
                            "SDLC + JavaScript Foundations",
                            "Node.js + Express.js",
                            "MongoDB + Mongoose ORM",
                            "React Basics + API Integration",
                            "AI Fundamentals + Integration",
                            "Testing + Azure basics and Deployment",
                            "Capstone Project + Review"
                        ].map((module, index) => (
                            <div key={index} className="flex items-center gap-6 p-6 rounded-2xl border border-[#4F46E5]/20 bg-[#EEF2FF]/50 hover:bg-[#EEF2FF] transition-colors">
                                <div className="w-10 h-10 rounded-full bg-[#4F46E5] text-white flex items-center justify-center font-bold text-lg flex-shrink-0">
                                    {index + 1}
                                </div>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {[
                            ...
                            <div key={index} className="flex gap-5 p-8 bg-gradient-to-br from-[#4F46E5] to-[#3730A3] rounded-2xl shadow-lg hover:shadow-xl transition-all border border-white/10 items-start transform hover:-translate-y-1">
            ...
            <div className="py-24 px-6 md:px-12 lg:px-24 bg-white">
                <div className="max-w-5xl mx-auto">
                    <div className="bg-gradient-to-br from-[#4F46E5] to-[#3730A3] rounded-3xl p-10 md:p-16 shadow-2xl text-center text-white relative overflow-hidden">
                        {/* Decorative circles */}
                        ...
                        <div className="space-y-6 text-left inline-block max-w-3xl relative z-10">
                            {[
                                "Start your career as a MERN developer with AI-enhanced MERN stack expertise.",
...
export default MernDeveloperTraining;
